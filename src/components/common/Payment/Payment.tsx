...
const Payment = ({description, price, submitSignal, successUrl}: PaymentProps) => {
    ...
    return (
        <div style={{display: "none"}}>
            <form ref={ref}  className="yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment"
                  method="post" acceptCharset="utf-8">

                <input readOnly={true} name="customerNumber" type="hidden" value={description}/>
                <div className="ym-hidden-inputs">
                    <input readOnly={true} name="shopSuccessURL" type="hidden" value={successUrl}/>
                </div>
                <div className="ym-payment-btn-block">
                    <div className="ym-input-icon-rub ym-display-none">
                        <input readOnly={true} name="sum" placeholder="0.00" className="ym-input ym-sum-input ym-required-input"
                               type="number" step="any" value={price}/>
                    </div>
                    <button data-text="Заплатить" className="ym-btn-pay ym-result-price"><span
                        className="ym-text-crop">Заплатить</span> <span
                        className="ym-price-output"> &nbsp;000,00&nbsp;₽</span></button>
                    <svg className="ym-logo" width="114" height="27" viewBox="0 0 114 27" fill="none"
                        ...
                        <path
                            ...
                            fill="black" fillOpacity="0.4"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="black" fillOpacity="0.4"></path>
                        <path d="M10.9367 3.93036V23.5823H6.1519L0 3.93036H10.9367Z" fill="black"
                    ...
                    {/*        <stop offset="1" stopColor="#00479C"></stop>*/}
                    {/*    </stop>*/}
                    {/*    /!*@ts-ignore *!/*/}
                    {/*</lineargradient>*/}
                    {/*/!*@ts-ignore *!/*/}
                ...
                <input name="shopId" type="hidden" value={SHOP_ID}/></form>
        </div>
    );
};
